                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="m-l-5 font-medium d-none d-sm-inline-block"> <i
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                ...
                                <div class="m-l-10">
                                    <p class=" m-b-0"> {{ Auth::guard('equipe')->user()->nom }} </p>
                                </div>
                            </div>
                            <div class="profile-dis scrollable">
                                <form id="logout-form" action="{{ route('equipe.logout') }}" method="POST" style="display: none;">
                                    @csrf
                                </form>
                                <a class="dropdown-item" href="{{ route('equipe.logout') }}"
...
{{--                            <li class="sidebar-item">--}}
{{--                                <a href="{{ url('client/devis/creer') }}" class="sidebar-link">--}}
{{--                                    <i class="mdi mdi-view-array"></i>--}}
{{--                                    <span class="hide-menu"> Faire devis </span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="sidebar-item">--}}
{{--                                <a href="{{ url('client/devis/liste') }}" class="sidebar-link">--}}
...
{{--                    </li>--}}
                    <li class="sidebar-item">
                        <a href="{{ url('equipe/etape/list') }}" class="sidebar-link">
                            <i class="fas fa-th-list"></i>
                            <span class="hide-menu">etape</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('equipe/classement-equipe') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
